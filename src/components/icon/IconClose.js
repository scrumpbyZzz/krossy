...
const IconClose = () => {
  ...
  return (
    <svg className='svg-icon-close' xmlns="http://www.w3.org/2000/svg" width="13.828" height="13.828" viewBox="0 0 13.828 13.828">
      <g id="Group_879" data-name="Group 879" transform="translate(-322.086 -44.086)">
        <line id="Line_45" data-name="Line 45" y1="11" x2="11" transform="translate(323.5 45.5)" fill="none"
              stroke="#aebfcf" stroke-linecap="round" stroke-width="2"/>
